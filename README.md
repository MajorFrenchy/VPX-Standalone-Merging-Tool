...
- **v1.83**: `CREATE CLEAN .VBS` now only creates `.vbs` files and skips all other copy/detection actions. Better image preview detection.
...
- **Windows:** `VPXmerge_v1.83-Windows.zip`
- **macOS:** `VPXmerge_v1.83-macOS.zip`
- **Linux x64:** `VPXmerge_v1.83-linux-amd64.run`
- **Linux ARM64:** `VPXmerge_v1.83-linux-arm64.run`

Linux quick launch:
```bash
chmod +x VPXmerge_v1.83-linux-*.run
./VPXmerge_v1.83-linux-*.run
```
